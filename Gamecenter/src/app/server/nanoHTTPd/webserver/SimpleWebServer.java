...
import app.server.nanoHTTPd.common.ServerRunner;
...
public class SimpleWebServer extends NanoHTTPD{
   ...
   public static NanoHTTPD serverInstance;
    ...
    public void startWebserver() {
        ...
        /*
        EchoSocketSample sample = new EchoSocketSample();
        try {
            sample.startWebSocket();
      ...
      serverInstance = ServerRunner.executeInstance(new SimpleWebServer(host, port, rootDirs, quiet));
    }
